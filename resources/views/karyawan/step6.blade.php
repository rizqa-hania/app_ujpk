    ...
    <div class="card form-card">
        ...
        <form action="{{ route('karyawan.storestep6') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-body">
                ...
                <h5 style="color: #0d6efd; margin-bottom: 20px;">KTP</h5>
                <div class="row">
                ...
                <h5 style="color: #0d6efd; margin-bottom: 20px;">Kartu Keluarga</h5>
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label>No. KK</label>
                ...
                <h5 style="color: #0d6efd; margin-bottom: 20px;">NPWP</h5>
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label>No. NPWP</label>
