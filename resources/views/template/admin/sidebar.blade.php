        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @else
                    ...
                    {{-- Tambah Pengguna --}}
                    <li class="nav-item has-treeview {{ request()->routeIs('admin.index') || request()->routeIs('karyawan.tambah.index') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->routeIs('admin.index') || request()->routeIs('karyawan.tambah.index') ? 'active' : '' }}">
                    ...
                    {{-- Data Master --}}
                    <li class="nav-item has-treeview {{ request()->is('jabatan*') || request()->is('pendidikan*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->is('jabatan*') || request()->is('pendidikan*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-archive"></i>
                            <p>Data Master <i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('master_jabatan.index') }}" class="nav-link {{ request()->routeIs('master_jabatan.index') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-briefcase"></i>
                                    <p>Jabatan</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('master_pendidikan.index') }}" class="nav-link {{ request()->routeIs('master_pendidikan.index') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-graduation-cap"></i>
                                    <p>Pendidikan</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('master_project.index') }}" class="nav-link {{ request()->routeIs('master_project.index') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-folder-open"></i>
                                    <p>Proyek</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('master_unit_pln.index') }}" class="nav-link {{ request()->routeIs('master_unit_pln.index') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-building"></i>
                                    <p>Master Unit</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('master-sub-unit.index') }}" class="nav-link {{ request()->routeIs('master_sub_unit.index') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-layer-group"></i>
                                    <p>Master Sub Unit</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('master_tad.index') }}" class="nav-link {{ request()->routeIs('master_tad.index') ? 'active' : '' }}">
                    ...
                    {{-- ABSENSI --}}
                    <li class="nav-item has-treeview {{ request()->is('absensi*') || request()->is('jadwal*') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->is('absensi*') || request()->is('jadwal*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-camera"></i>
                            <p>Absensi <i class="right fas fa-angle-left"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.absensi.monitoring') }}" class="nav-link {{ request()->routeIs('admin.absensi.monitoring') ? 'active' : '' }}">
